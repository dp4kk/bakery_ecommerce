...
const Datacontext = ({children}) => {
    ...
    const checkout=()=>{
        ...
        const contexts={
            increase,decrease,addProduct,removeProduct,clearCart,checkout,loginOpen,handleLoginClose,setLoginOpen,signupOpen,setSignupOpen,handleSignupClose,handleLoginOpen,handleSignupOpen,anchorEl,handleAnchorClick,handleAnchorClose,anchortwo,setAnchortwo,handleAnchorClicktwo,handleAnchorClosetwo,email,password,confirmPassword,handleEmailChange,handlePasswordChange,handleConfirmPasswordChange,setEmail,setPassword,setConfirmPassword,transactionMsg,setTransactionMsg,...state
        }
